...
if [ $IS_USE_GPU == 1 ]
    then
        ...
        gcc -fPIC -shared -O3 -o $DETECTOR_LIB_PATH/libdetector_c.so detector.c -I. -I$DARKNET_SRC_PATH -I$OPENCV_INCLUDE_PATH -I/usr/local/cuda/include -L$DARKNET_LIB_PATH -L/usr/local/cuda/lib64 -ldarknet -fopenmp -lgomp -DOPENCV -DOPENBLAS -DGPU
    else
